...
const Profile = () => {
  ...
  const {isFollow  , toggleFollow , isProcessing} = useFollow(profileId , currentUser);
    useEffect(() => {
      ...
      <div className="max-w-[1200px] mx-auto">
          <section className="pt-16 flex flex-col gap-10 border-b border-black-2">
              <div className="flex py-6 flex-col gap-8">
                  <h1 className=" text-5xl text-black-2 font-semibold">{Data ? Data.name : ""}</h1>
                  <div className=" flex gap-2 items-center justify-between w-fit">
                      ...
                      <Button disabled={isProcessing} variant={!isFollow ? "follow" : "outFollow"}  onClick={toggleFollow} >
                  ...
                  <ul className=" text-black-2  text-sm font-semibold flex items-center gap-10">
                      <Link to="about">
                          <li onClick={() => {
                              ...
                              "border-b-2 border-orange-1": showAbout
                          })}>About
                          </li>
                      </Link>
                      <Link to="home">
                          <li onClick={() => {
                              ...
                              "border-b-2 border-orange-1": showHome
                          })}>Home
                          </li>
                      </Link>
          ...
          <div className="flex flex-row p-6 gap-4">
              ...
              <div className=" p-4 flex flex-col w-[30%] items-center border-l border-black-2 px-6  gap-5">
                  <img src={Data ? Data.PhotoUrl : ""} width={80} className="rounded-full"/>
                  ...
                  <div className="flex flex-row gap-2 justify-center items-center">
                    {ProfileAttributes.map((value , index) => {
                        ...
                        return (
                            <>
                                {index == 1 && <div className=" w-[1px] bg-black-2 h-full mr-2"></div>}
